...
(1,'https://www.lighthouselabs.ca/', 'Lighthouse Labs', 'The leading Web Development bootcamp in Canada!', 'Coding', now()::date, NULL),
...
(2,'https://developer.mozilla.org/en-US/', 'MDN Web Docs', 'Resources for developers, by developers.', 'Coding', now()::date, NULL),
