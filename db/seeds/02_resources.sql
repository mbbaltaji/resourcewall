...
(1,'https://www.espn.com/', 'ESPN', 'Serving sports fans. Anytime. Anywhere.', 'Sports', now()::date, NULL),
...
(1,'https://www.lighthouselabs.ca/', 'Lighthouse Lab', 'The leading Web Development bootcamp in Canada!', 'Coding', now()::date, NULL),
(2,'https://www.deviantart.com/', 'Deviant Art', 'The largest Online Art Gallery and Community', 'Art', now()::date, NULL),
(1,'https://www.rollingstone.com/music/music-news/', 'Rolling Stone', 'All the latest in music news.', 'Music', now()::date, NULL),
...
(1,'https://www.daringgourmet.com/toad-in-the-hole-british-sausage-and-yorkshire-pudding-bake/', 'Toad in the Hole', 'A quintessential British dish, Toad in the Hole is comprised of roasted sausages enveloped in a giant, deliciously crispy Yorkshire pudding.', 'Cooking', now()::date, NULL),
...
(1,'https://www.uefa.com/uefachampionsleague/', 'UEFA', 'The official site for the UEFA Champions League', 'Sports', now()::date, NULL),
...
(2,'https://www.developer.mozilla.org/en-US/', 'MDN Web Docs', 'Resources for developers, by developers.', 'Coding', now()::date, NULL),
...
(2,'https://www.iflscience.com/', 'IFL Science', 'IFLScience is a UK-based science website', 'Educational', now()::date, NULL),
(1,'https://www.clever.com/', 'Clever', 'The most widely used single sign-on portal in K-12 education.', 'Educational', now()::date, NULL),
...
(1,'https://www.albumoftheyear.org/genre/1-indie-rock/2022/', 'Album of the Year', 'The Best Indie Rock Albums of 2022', 'Music', now()::date, NULL),
